...
async function fetchJsonFromUrl(url) {
  ...
  async function getTweakHeaderImage(tweak) {
    if (!tweak.SileoDepiction) {
      ...
      return '/static//img/bernar.png'; // Default image if SileoDepiction URL is missing
    }
    ...
    if (depictionData && depictionData.headerImage) {
      ...
      return '/static//img/bernar.png'; // Default image if headerImage is not found
    }
  }
    ...
    fetch("https://api.amania.jp/random-tweak?count=10")
      ...
      .then(data => {
        ...
        data.forEach(tweak => {
          ...
          img.src = tweak.Icon;
          img.onerror = function(){this.onerror=null;this.src='/static//img/bernar.png'}
          ...
          repository_icon.src = tweak.repository + '/static/CydiaIcon.png'
